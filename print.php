...
include'include/header1.php'; 
   ...
   //  $name=$applicant['full_name'];
    ...
    if($declaration==1){
      ...
      ';
      $print='<li  class=" btn btn-info" onclick=(printFunc())> <a href=""><i class="fas fa-print"></i>Print</a> </li> ';
    }else{
...
<li style="float:left;" class="btn btn-primary"><a href="approved.php" ><i class="fas fa-arrow-circle-left"></i> BACK</a></li>
...
function printFunc(){
 ...
 var divToPrint = document.getElementById('print');
    ...
    newWin.document.write("<img src='images/header.PNG'  width='100%'/>");
