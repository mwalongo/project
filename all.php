...
<li  class="fas fa-sign-out-alt btn btn-danger"><a href="logout.php">Logout</a> </li>
        ...
        <!-- .................................. all goes here --> 
       <h4 class="well">All Application</h4>   
...
$sql = "SELECT * FROM applications WHERE declaration='1'  ORDER BY experience DESC LIMIT $start_from, $limit";  
$rs_result = mysqli_query($link, $sql); 
if(mysqli_num_rows($rs_result)>0){
?>
 <thead><th>No</th><th>@ Email</th><th>Name</th><th>Title</th><th>Experience</th><th>Nationality</th> 
</thead>
<tbody>
<?php 
$sn=1;
