...
<li  class="fas fa-sign-out-alt btn btn-danger"> <a href="logout.php">Logout</a> </li>
        ...
        <!-- .................................. all goes here --> 
        <h4 class="well">Applied Lawyers</h4>   
   ...
   $sql = "SELECT * FROM applications WHERE declaration='1' AND approve='Notapproved' ORDER BY experience DESC LIMIT $start_from, $limit";  
   $rs_result = mysqli_query($link, $sql); 
   if(mysqli_num_rows($rs_result)>0){
   ?>
<thead>
<th>No</th><th>Name</th><th>@ Email</th><th>Title</th><th>Experience</th>
...
<td><?php echo "<a href='preview.php?email2=$member[email]' > <i class='fas fa-eye'></i></a>";?></td>
...
<div class="col md-12">
<button type="button" name="btn_approve" id="btn_approve" class="btn btn-success pull-center"> Approve</button>
</div>
</div>
<td></tr>
';
...
<div class="col-md-10 col-md-offset-1">
               ...
               $page_link="<ul class='pagination'>";
                  ...
                  if(!empty($total_pages)):for($i=1; $i<=$total_pages; $i++):
                   if($i==1):
                     $page_link.="<li  class='page-item active'  id=".$i."><a href='approve.php?page=".$i."'>".$i."</a></li>";

                   else:
                     $page_link.="<li  class='page-item '  id=".$i."><a href='approve.php?page=".$i."'>".$i."</a></li>";
           ...
           echo $page_link."</ul>";
                ...
                echo' <tr><td colspan="8" align="center"><h3> Currently there is no  Applied Lawyer</h3></td></tr> ';
