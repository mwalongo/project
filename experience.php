...
<label for="">Start Date <b class="text-danger"> * </b></label>
       <input type="date" name="from_date"  class="form-control" placeholder="select start date">
</div>
...
$years=$interval->format('%Y');
 ...
 if($years2>=5){
    $qry="UPDATE  applications SET experience='$years2' WHERE  email='$email'";
...
$no=1;
 ...
 echo'<tr><th colspan="6" align="center">ADDED  EXPERIENCE&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;   Your Years of Experience is &nbsp;&nbsp;  <b class="text-success">'.$years2.'</th></tr>';
